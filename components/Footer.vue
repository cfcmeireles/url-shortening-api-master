  ...
  <main class="h-46 lg:h-96 bg-blackviolet">
    ...
    >
      ...
      <FooterList>
        ...
        <template #second-item>Branded Links</template>
        <template #third-item>Analytics</template>
      </FooterList>
      <FooterList>
        <template #title>Resources</template>
        <template #first-item>Blog</template>
        <template #second-item>Developers</template>
    ...
    <div class="attribution text-white ml-3 mt-28">
      Challenge by
      <a
        class="text-cyan"
        ...
        >Frontend Mentor</a
      >. Coded by
      <a class="text-cyan" href="https://github.com/cfcmeireles" target="_blank"
        >Carina Meireles</a
      >.
    </div>
  </main>
